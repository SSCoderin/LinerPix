 ...
 <div className="mt-10 mx-6 md:mx-20">
  <div className="flex flex-col gap-8">
    ...
    <div className="flex flex-col md:flex-row gap-6">
      <div className="flex-1 bg-white border-2 border-red-200 rounded-xl shadow p-6">
      ...
      <div className="flex-[2] flex flex-row flex-wrap items-center gap-4 border-2 border-red-200 rounded-xl shadow p-6">
        {TaskData.length > 0 ? (
